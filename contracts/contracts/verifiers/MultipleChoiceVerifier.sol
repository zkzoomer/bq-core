...
contract MultipleChoiceVerifier {
    using Pairing for *;
    struct VerifyingKey {
    ...
    function verifyingKey() internal pure returns (VerifyingKey memory vk) {
        ...
        vk.delta2 = Pairing.G2Point(
            [17740541606571993543734482099112753679204239805307352464226194942329359824614,
             17368949846530199885192561889480767169768507080046668492187910507284931234156],
            [18188109736774204069427237175833825989555724811433408246315980540888701194598,
             8896365608835625044759708290025181933543329540987764214933358934397452245889]
        );
