...
async function main() {
    ...
    console.log("Deployed TestCreator contract at: ", testCreator.address)
    // 0x403E6BBCB3Ddbe3487c09E8827e5dEf058FE6db4

    const credentials = await testCreator.credentialsContract()
    console.log("TestCreator deployed Credentials contract at: ", credentials)
    // 0x1B54cCe0f362fF29696c710Fa86B9Add98164C88

    const verifier = await testCreator.verifierContract()
    console.log("TestCreator deployed TestVerifier contract at: ", verifier)
